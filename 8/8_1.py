...
def inverse_slope(x_current, x_previous):
    return (x_current - x_previous) / (f(x_current) - f(x_previous))
...
def secant_approximation(x_start: float, epsilon: float):
    x_old = x_start
    x = x_start
    k = 0
    for k in range(1000):
...
def parabolic_approximation(x_start: float, epsilon: float):
    x_older = x_start
    x_old = x_start
    x = x_start
    k = 0
    for k in range(1000):
        ...
        f_coo = (inverse_slope(x_old, x_older) - inverse_slope(x_older, x_oldest)) / (x_oldest - x_old)
...
def inverse_interpolation_approximation(x_start: float, epsilon: float):
    x_old = x_start
    x = x_start
    k = 0
    for k in range(1000):
...
print_information_about_approximation(secant_approximation(rising_starting_approximation_x, epsilon), "rising, secant")
print_information_about_approximation(secant_approximation(falling_starting_approximation_x, epsilon), "falling, secant")

print_information_about_approximation(parabolic_approximation(rising_starting_approximation_x, epsilon), "rising, parabolic")
print_information_about_approximation(parabolic_approximation(falling_starting_approximation_x, epsilon), "falling, parabolic")

print_information_about_approximation(inverse_interpolation_approximation(rising_starting_approximation_x, epsilon), "rising, inverse interpolation")
print_information_about_approximation(inverse_interpolation_approximation(falling_starting_approximation_x, epsilon), "falling, inverse interpolation")
